...
public class App {
    ...
    public static void main(String[] args) {
        ...
        //  Création de plusieurs horloges observant le même service
        new Horloge("Horloge 1", timerService);
        new Horloge("Horloge 2", timerService);
        new Horloge("Horloge 3", timerService);

        //  Création d'un compte à rebours de 5 secondes
        new CompteARebours("Compteur 5 sec", 5, timerService);

        //  Création de 10 compteurs aléatoires entre 10 et 20
        ...
        // ⃣ Le DummyTimeService s'occupe de notifier les observateurs automatiquement
    }
